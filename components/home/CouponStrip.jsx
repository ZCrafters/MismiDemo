...
// Swipeable coupon strip (Sociolla voucher pattern): voucher cards with copyable
// codes. Codes & amounts are illustrative demo — real vouchers live only at the
// official store (stated explicitly in the footnote).
