...
export function CheckoutFlow() {
  ...
  const orderId = useMemo(() => "SLM-" + Math.random().toString(36).slice(2, 8).toUpperCase(), []);
  ...
  const applyCoupon = () => {
    ...
    const COUPONS = { "LEMOEN10": { type: "percent", value: 0.1, label: "10% off" }, "HEMAT20K": { type: "flat", value: 20000, label: "Rp 20.000 off" } };
              ...
              <div className="coupon-row">
                ...
                <div className="coupon-input">
                  <input id="coupon" type="text" value={coupon} onChange={(e) => setCoupon(e.target.value)}
                    placeholder="LEMOEN10 atau HEMAT20K" autoComplete="off" />
