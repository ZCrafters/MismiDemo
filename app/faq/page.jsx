...
export const metadata = { title: "FAQ — Suur Lemoen" };
...
const FAQS = [
  ...
  { q: "Apakah bisa retur?", a: "Mengikuti kebijakan retur official store Suur Lemoen tempat kamu membeli. Simpan kemasan & struk untuk proses penukaran." },
  { q: "Kenapa tiap produk ada ukuran kemasan seperti 250ml / 500ml / 1 Liter / 700gr?", a: "Setiap SKU adalah produk dengan ukuran kemasan resmi tertentu. Pilih produk sesuai kebutuhan — tanpa perlu pilih size S/M/L." },
  { q: "Nomor BPOM / sertifikat Halal di mana?", a: "Nomor registrasi BPOM (MD...) & sertifikat Halal ditampilkan di halaman detail tiap produk bila tersedia di listing resmi." },
  ...
  { q: "Di mana bisa beli produk asli?", a: "Official store Suur Lemoen: Tokopedia (suurlemoenid), Shopee (suurlemoen.id), Lazada (suur-lemoen-id), dan TikTok (@suurlemoenofficial)." },
];
