...
// Mega menu: rutinitas & kategori tas Mismi.
export const MEGA_MENU = [
  { title: "Tas Selempang", desc: "Sling bag favorit, manis tiap hari", links: [{ label: "Tas Selempang", cat: "tas-selempang" }, { label: "Sling Bag Water Resistant", cat: "tas-selempang" }, { label: "Sling Bag Korean Style", cat: "tas-selempang" }] },
  { title: "Tas Ransel", desc: "Untuk sekolah, kerja & jalan-jalan", links: [{ label: "Tas Ransel", cat: "tas-ransel" }] },
  { title: "Tote Bag", desc: "Tas jinjing simpel & stylish", links: [{ label: "Tote Bag", cat: "tote-bag" }] },
];
